...
def get_supported_codecs():
    ...
    return [line.strip("/").lower() for line in iconv.communicate()[0].splitlines()]
        ...
        def iconvencode(input, errors="strict", encoding=codec_name):
            ...
            if errors == "ignore":
                ...
                raise NotImplementedError(
                    "%r error handling not implemented"
...
if __name__ == "__main__":
    ...
    print(
        "Here are the %i codecs that Python does not know, but iconv does:"
